...
public class NetworkRequestDelegateDataTask: NetworkRequestDelegate {
    var dataTaskDidReceiveResponse: NetworkDataTaskReceivedResponseBlock? = nil
    var dataTaskDidBecomeDownloadTask: NetworkDataTaskBecameDownloadTaskBlock? = nil
    var dataTaskDidReceiveData: NetworkDataTaskReceivedDataBlock? = nil
    var dataTaskWillCacheResponse: NetworkDataTaskWillCacheResponseBlock? = nil
    var dataTaskProgressed: NetworkDataTaskProgressedBlock? = nil
...
extension NetworkRequestDelegateDataTask: NSURLSessionDataDelegate {
